...
@section('title', 'Nouveau compte parent')
@section('page-title', 'Nouveau compte parent')
...
@section('content')
    ...
    <form action="{{ route('parents.store') }}" method="POST" style="max-width:680px">
    @csrf
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Ex: SIDIBÉ Issa">
        ...
        <div class="card">
            <div class="card-header">👨‍🎓 Enfant(s) à associer à ce compte *</div>
            <div class="card-body">
                ...
                <div style="max-height:280px; overflow-y:auto; border:1px solid var(--color-border); border-radius:8px; padding:10px;">
                    ...
                    <div class="checkbox-row">
                        <input type="checkbox" name="enfants[]" id="eleve-{{ $eleve->id }}" value="{{ $eleve->id }}"
                               {{ in_array($eleve->id, old('enfants', [])) ? 'checked' : '' }}>
