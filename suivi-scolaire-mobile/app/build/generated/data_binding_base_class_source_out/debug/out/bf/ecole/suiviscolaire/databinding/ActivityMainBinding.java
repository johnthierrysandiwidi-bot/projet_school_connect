...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final Spinner spinnerEnfants;
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull Spinner spinnerEnfants, @NonNull Toolbar toolbar) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.spinnerEnfants;
      Spinner spinnerEnfants = ViewBindings.findChildViewById(rootView, id);
