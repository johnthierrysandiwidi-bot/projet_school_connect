...
public final class ActivityPdfViewerBinding implements ViewBinding {
  ...
  private ActivityPdfViewerBinding(@NonNull LinearLayout rootView,
      @NonNull MaterialButton buttonShare, @NonNull LinearLayout pagesContainer,
  ...
  public static ActivityPdfViewerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.pagesContainer;
      LinearLayout pagesContainer = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityPdfViewerBinding((LinearLayout) rootView, buttonShare, pagesContainer,
          toolbar);
    }
